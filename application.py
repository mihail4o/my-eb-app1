...
<body id="sample">
  <div class="textColumn">
    <h1>Congratulations! You have to practice!</h1>
    <p>Your first AWS Elastic Beanstalk. This is Awesome! Python Application is now running on your own dedicated environment in the AWS Cloud</p>
  </div>
